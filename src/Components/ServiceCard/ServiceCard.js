...
const ServiceCard = (props) => {
    ...
    return (
        <div>
            <div className="card serviceCard" style={{width: 18+ 'rem'}}>
                <div className="card-body">
                    ...
                    <Link to={'/form'}>
                    <button onClick={()=>props.handleAppointment(props.service)} className= 'btn btn-warning'>Book Appointment</button>
                    </Link>
                </div>
            </div>
